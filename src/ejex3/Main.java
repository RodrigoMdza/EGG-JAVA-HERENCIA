...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Hoteles4 h41 = new Hoteles4();
        h41.crearHotal4();
        alojamientos.add(h41);
        Hoteles5 h51 = new Hoteles5();
        h51.crearHotal5();
        alojamientos.add(h51);
        ...
        for (Alojamientos aux : alojamientos) {
            if (aux instanceof Camping) {
                if (((Camping) aux).isResto() == true) {
                    System.out.println(aux);
                } else {
                    System.out.println("NINGUNO TIENE RESTO");
                }
            }
            if (aux instanceof Residencia) {
                if (((Residencia) aux).isDescuento() == true) {
                    System.out.println(aux);
                } else {
                    System.out.println("NINGUNO TIENE DESCUENTO");
                }
            }
        }

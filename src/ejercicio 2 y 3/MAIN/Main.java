...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (Electrodomestico aux : lista) {
            contadortotal += aux.getPrecio();
        }
        System.out.println("El precio total de la lista es " + contadortotal);
        Integer contadorlavadora = 0;
        for (Electrodomestico aux : lista) {
            if (aux instanceof Lavadora) {
                contadorlavadora += aux.getPrecio();
            }
        }
        System.out.println("El precio de las lavadoras es " + contadorlavadora);
        Integer contadortv = 0;
        for (Electrodomestico aux : lista) {
            if (aux instanceof Televisor) {
                contadortv += aux.getPrecio();
            }
        }
        System.out.println("El precio de los TV es " + contadortv);
    }
}
